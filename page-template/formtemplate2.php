<?php
/**
 * Template Name: Form Template 2.1
 */
  ...
  <div class="content-vw">
	...
	<div id="primary" class="content-area">
		...
		<form methods="POST">
			...
			<br><br>
            Butter<input type="checkbox" name ="Butter">
			<br><br>
            Eggs<input type="checkbox" name ="Eggs">
			<br><br>
            Flour<input type="checkbox" name ="Flour">
			<br><br>
            Vanilla Extract<input type="checkbox" name ="Vanilla Extract">
			<br><br>
            Salt<input type="checkbox" name ="Salt">
			<br><br>
			Baking Soda<input type="checkbox" name ="Baking Soda">
			<br><br>
            Baking Powder<input type="checkbox" name ="Baking Powder">
			<br><br>
            Brown Sugar<input type="checkbox" name ="Brown Sugar">
			<br><br>
            Cream cheese<input type="checkbox" name ="Cream cheese">
            <br><br>
			<input type="submit" value ="Find Recipe" name="insert">
			<br><br>	
